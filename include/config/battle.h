...
// Stat settings
#define B_BADGE_BOOST               GEN_3      // emerald+: badges boost stats again (+10%, player side only, Hoenn badge flags).
...
#define B_AFFECTION_MECHANICS           FALSE      // emerald+: no Gen 6 affection effects in battle.
