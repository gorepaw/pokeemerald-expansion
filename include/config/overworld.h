...
// Other settings
#define OW_POISON_DAMAGE                GEN_3      // emerald+: poison damages in the overworld and can faint, as in RSE.
...
#define OW_FLAG_POKE_RIDER          FLAG_POKE_RIDER  // emerald+: Fly from the Pokenav Region Map / Town Map with R.
                                                     // Earned by clearing the Kanto league - set in the Kanto Hall of Fame script.
