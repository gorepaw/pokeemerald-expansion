...
// emerald+: the FRLG flag names above/below were all stubbed to 0 upstream, which
// made Kanto maps unassemblable ("Hidden Item flag 0 is too small"). They are now
// allocated a real contiguous block so Kanto can be walkable postgame content.
#define FRLG_FLAGS_START (DAILY_FLAGS_END + 1)
...
#define FLAG_HIDE_BULBASAUR_BALL                           (FRLG_FLAGS_START + 0)
#define FLAG_HIDE_SQUIRTLE_BALL                            (FRLG_FLAGS_START + 1)
#define FLAG_HIDE_CHARMANDER_BALL                          (FRLG_FLAGS_START + 2)
#define FLAG_HIDE_OAK_IN_HIS_LAB                           (FRLG_FLAGS_START + 3)
#define FLAG_HIDE_OAK_IN_PALLET_TOWN                       (FRLG_FLAGS_START + 4)
#define FLAG_HIDE_RIVAL_IN_LAB                             (FRLG_FLAGS_START + 5)
#define FLAG_HIDE_PEWTER_CITY_GYM_GUIDE                    (FRLG_FLAGS_START + 6)
#define FLAG_HIDE_DOME_FOSSIL                              (FRLG_FLAGS_START + 7)
#define FLAG_HIDE_HELIX_FOSSIL                             (FRLG_FLAGS_START + 8)
#define FLAG_HIDE_NUGGET_BRIDGE_ROCKET                     (FRLG_FLAGS_START + 9)
#define FLAG_HIDE_BILL_CLEFAIRY                            (FRLG_FLAGS_START + 10)
#define FLAG_HIDE_BILL_HUMAN_SEA_COTTAGE                   (FRLG_FLAGS_START + 11)
#define FLAG_HIDE_TOWER_FUJI                               (FRLG_FLAGS_START + 12)
#define FLAG_HIDE_POKEHOUSE_FUJI                           (FRLG_FLAGS_START + 13)
#define FLAG_HIDE_LIFT_KEY                                 (FRLG_FLAGS_START + 14)
#define FLAG_HIDE_SILPH_SCOPE                              (FRLG_FLAGS_START + 15)
#define FLAG_HIDE_HIDEOUT_GIOVANNI                         (FRLG_FLAGS_START + 16)
#define FLAG_HIDE_TOWN_MAP                                 (FRLG_FLAGS_START + 17)
#define FLAG_HIDE_POKEDEX                                  (FRLG_FLAGS_START + 18)
#define FLAG_HIDE_CERULEAN_ROCKET                          (FRLG_FLAGS_START + 19)
#define FLAG_HIDE_CERULEAN_RIVAL                           (FRLG_FLAGS_START + 20)
#define FLAG_HIDE_SS_ANNE_RIVAL                            (FRLG_FLAGS_START + 21)
#define FLAG_HIDE_SAFFRON_ROCKETS                          (FRLG_FLAGS_START + 22)
#define FLAG_HIDE_SAFFRON_CIVILIANS                        (FRLG_FLAGS_START + 23)
#define FLAG_HIDE_SEAFOAM_1F_BOULDER_1                     (FRLG_FLAGS_START + 24)
#define FLAG_HIDE_SEAFOAM_1F_BOULDER_2                     (FRLG_FLAGS_START + 25)
#define FLAG_HIDE_SEAFOAM_B1F_BOULDER_1                    (FRLG_FLAGS_START + 26)
#define FLAG_HIDE_SEAFOAM_B1F_BOULDER_2                    (FRLG_FLAGS_START + 27)
#define FLAG_HIDE_SEAFOAM_B2F_BOULDER_1                    (FRLG_FLAGS_START + 28)
#define FLAG_HIDE_SEAFOAM_B2F_BOULDER_2                    (FRLG_FLAGS_START + 29)
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_1                    (FRLG_FLAGS_START + 30)
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_2                    (FRLG_FLAGS_START + 31)
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_3                    (FRLG_FLAGS_START + 32)
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_4                    (FRLG_FLAGS_START + 33)
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_5                    (FRLG_FLAGS_START + 34)
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_6                    (FRLG_FLAGS_START + 35)
#define FLAG_HIDE_SEAFOAM_B4F_BOULDER_1                    (FRLG_FLAGS_START + 36)
#define FLAG_HIDE_SEAFOAM_B4F_BOULDER_2                    (FRLG_FLAGS_START + 37)
#define FLAG_HIDE_SILPH_RIVAL                              (FRLG_FLAGS_START + 38)
#define FLAG_HIDE_ROUTE_22_RIVAL                           (FRLG_FLAGS_START + 39)
#define FLAG_HIDE_PEWTER_MUSEUM_GUIDE                      (FRLG_FLAGS_START + 40)
#define FLAG_HIDE_TOWER_RIVAL                              (FRLG_FLAGS_START + 41)
#define FLAG_HIDE_MOLTRES                                  (FRLG_FLAGS_START + 42)
#define FLAG_HIDE_SILPH_ROCKETS                            (FRLG_FLAGS_START + 43)
#define FLAG_HIDE_ROUTE_12_SNORLAX                         (FRLG_FLAGS_START + 44)
#define FLAG_HIDE_VIRIDIAN_GIOVANNI                        (FRLG_FLAGS_START + 45)
#define FLAG_HIDE_OLD_AMBER                                (FRLG_FLAGS_START + 46)
#define FLAG_HIDE_EEVEE_BALL                               (FRLG_FLAGS_START + 47)
#define FLAG_HIDE_VICTORY_ROAD_2F_BOULDER                  (FRLG_FLAGS_START + 48)
#define FLAG_HIDE_VICTORY_ROAD_3F_BOULDER                  (FRLG_FLAGS_START + 49)
#define FLAG_HIDE_OAK_IN_CHAMP_ROOM                        (FRLG_FLAGS_START + 50)
#define FLAG_HIDE_GAME_CORNER_ROCKET                       (FRLG_FLAGS_START + 51)
#define FLAG_HIDE_CERULEAN_CAVE_GUARD                      (FRLG_FLAGS_START + 52)
#define FLAG_HIDE_ZAPDOS                                   (FRLG_FLAGS_START + 53)
#define FLAG_HIDE_TOWER_ROCKET_1                           (FRLG_FLAGS_START + 54)
#define FLAG_HIDE_CELADON_ROCKETS                          (FRLG_FLAGS_START + 55)
#define FLAG_HIDE_DOJO_HITMONLEE_BALL                      (FRLG_FLAGS_START + 56)
#define FLAG_HIDE_DOJO_HITMONCHAN_BALL                     (FRLG_FLAGS_START + 57)
#define FLAG_HIDE_CINNABAR_BILL                            (FRLG_FLAGS_START + 58)
#define FLAG_HIDE_UNION_ROOM_PLAYER_1                      (FRLG_FLAGS_START + 59)
#define FLAG_HIDE_UNION_ROOM_PLAYER_2                      (FRLG_FLAGS_START + 60)
#define FLAG_HIDE_UNION_ROOM_PLAYER_3                      (FRLG_FLAGS_START + 61)
#define FLAG_HIDE_UNION_ROOM_PLAYER_4                      (FRLG_FLAGS_START + 62)
#define FLAG_HIDE_UNION_ROOM_PLAYER_5                      (FRLG_FLAGS_START + 63)
#define FLAG_HIDE_UNION_ROOM_PLAYER_6                      (FRLG_FLAGS_START + 64)
#define FLAG_HIDE_UNION_ROOM_PLAYER_7                      (FRLG_FLAGS_START + 65)
#define FLAG_HIDE_UNION_ROOM_PLAYER_8                      (FRLG_FLAGS_START + 66)
#define FLAG_HIDE_CINNABAR_SEAGALLOP                       (FRLG_FLAGS_START + 67)
#define FLAG_HIDE_SAFFRON_FAN_CLUB_BLACKBELT               (FRLG_FLAGS_START + 68)
#define FLAG_HIDE_SAFFRON_FAN_CLUB_ROCKER                  (FRLG_FLAGS_START + 69)
#define FLAG_HIDE_SAFFRON_FAN_CLUB_WOMAN                   (FRLG_FLAGS_START + 70)
#define FLAG_HIDE_SAFFRON_FAN_CLUB_BEAUTY                  (FRLG_FLAGS_START + 71)
#define FLAG_HIDE_MG_DELIVERYMEN                           (FRLG_FLAGS_START + 72)
#define FLAG_HIDE_ONE_ISLAND_BILL                          (FRLG_FLAGS_START + 73)
#define FLAG_HIDE_ONE_ISLAND_POKECENTER_BILL               (FRLG_FLAGS_START + 74)
#define FLAG_HIDE_ONE_ISLAND_POKECENTER_CELIO              (FRLG_FLAGS_START + 75)
#define FLAG_HIDE_TWO_ISLAND_GAME_CORNER_BIKER             (FRLG_FLAGS_START + 76)
#define FLAG_HIDE_TWO_ISLAND_GAME_CORNER_LOSTELLE          (FRLG_FLAGS_START + 77)
#define FLAG_HIDE_LOSTELLE_IN_HER_HOME                     (FRLG_FLAGS_START + 78)
#define FLAG_0x077                                         0
#define FLAG_0x078                                         0
#define FLAG_HIDE_THREE_ISLAND_BIKERS                      (FRLG_FLAGS_START + 79)
#define FLAG_HIDE_LOSTELLE_IN_BERRY_FOREST                 (FRLG_FLAGS_START + 80)
#define FLAG_HIDE_TWO_ISLAND_WOMAN                         (FRLG_FLAGS_START + 81)
#define FLAG_HIDE_TWO_ISLAND_BEAUTY                        (FRLG_FLAGS_START + 82)
#define FLAG_HIDE_TWO_ISLAND_SUPER_NERD                    (FRLG_FLAGS_START + 83)
#define FLAG_HIDE_THREE_ISLAND_ANTIBIKERS                  (FRLG_FLAGS_START + 84)
#define FLAG_0x07F                                         0
#define FLAG_HIDE_ROUTE_16_SNORLAX                         (FRLG_FLAGS_START + 85)
#define FLAG_HIDE_MEWTWO                                   (FRLG_FLAGS_START + 86)
#define FLAG_HIDE_ARTICUNO                                 (FRLG_FLAGS_START + 87)
#define FLAG_HIDE_TOWER_ROCKET_2                           (FRLG_FLAGS_START + 88)
#define FLAG_HIDE_TOWER_ROCKET_3                           (FRLG_FLAGS_START + 89)
#define FLAG_HIDE_POWER_PLANT_ELECTRODE_1                  (FRLG_FLAGS_START + 90)
#define FLAG_HIDE_POWER_PLANT_ELECTRODE_2                  (FRLG_FLAGS_START + 91)
#define FLAG_HIDE_SS_ANNE                                  (FRLG_FLAGS_START + 92)
#define FLAG_HIDE_FIVE_ISLAND_ROCKETS                      (FRLG_FLAGS_START + 93)
#define FLAG_HIDE_MT_EMBER_EXTERIOR_ROCKETS                (FRLG_FLAGS_START + 94)
#define FLAG_HIDE_RUBY                                     (FRLG_FLAGS_START + 95)
#define FLAG_HIDE_ICEFALL_CAVE_LORELEI                     (FRLG_FLAGS_START + 96)
#define FLAG_HIDE_LORELEI_IN_HER_HOUSE                     (FRLG_FLAGS_START + 97)
#define FLAG_HIDE_ICEFALL_CAVE_ROCKETS                     (FRLG_FLAGS_START + 98)
#define FLAG_HIDE_RUIN_VALLEY_SCIENTIST                    (FRLG_FLAGS_START + 99)
#define FLAG_HIDE_SAPPHIRE                                 (FRLG_FLAGS_START + 100)
#define FLAG_HIDE_DOTTED_HOLE_SCIENTIST                    (FRLG_FLAGS_START + 101)
#define FLAG_HIDE_THREE_ISLAND_LONE_BIKER                  (FRLG_FLAGS_START + 102)
#define FLAG_HIDE_PEWTER_CITY_RUNNING_SHOES_GUY            (FRLG_FLAGS_START + 103)
#define FLAG_HIDE_LOST_CAVE_SELPHY                         (FRLG_FLAGS_START + 104)
#define FLAG_HIDE_RESORT_GORGEOUS_SELPHY                   (FRLG_FLAGS_START + 105)
#define FLAG_HIDE_RESORT_GORGEOUS_INSIDE_SELPHY            (FRLG_FLAGS_START + 106)
#define FLAG_HIDE_SELPHYS_BUTLER                           (FRLG_FLAGS_START + 107)
#define FLAG_HIDE_FOUR_ISLAND_RIVAL                        (FRLG_FLAGS_START + 108)
#define FLAG_HIDE_SIX_ISLAND_POKECENTER_RIVAL              (FRLG_FLAGS_START + 109)
#define FLAG_HIDE_BIRTH_ISLAND_METEORITE                   (FRLG_FLAGS_START + 110)
#define FLAG_HIDE_POSTGAME_GOSSIPERS                       (FRLG_FLAGS_START + 111)
#define FLAG_HIDE_FAME_CHECKER_ERIKA_JOURNALS              (FRLG_FLAGS_START + 112)
#define FLAG_HIDE_FAME_CHECKER_KOGA_JOURNAL                (FRLG_FLAGS_START + 113)
#define FLAG_HIDE_FAME_CHECKER_LT_SURGE_JOURNAL            (FRLG_FLAGS_START + 114)
#define FLAG_HIDE_VERMILION_CITY_OAKS_AIDE                 (FRLG_FLAGS_START + 115)
#define FLAG_HIDE_CINNABAR_POKECENTER_BILL                 (FRLG_FLAGS_START + 116)
#define FLAG_HIDE_CREDITS_RIVAL                            (FRLG_FLAGS_START + 117)
#define FLAG_HIDE_CREDITS_OAK                              (FRLG_FLAGS_START + 118)
#define FLAG_HIDE_LORELEI_HOUSE_MEOWTH_DOLL                (FRLG_FLAGS_START + 119)
#define FLAG_HIDE_LORELEI_HOUSE_CHANSEY_DOLL               (FRLG_FLAGS_START + 120)
#define FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_F_DOLL            (FRLG_FLAGS_START + 121)
#define FLAG_HIDE_LORELEI_HOUSE_JIGGLYPUFF_DOLL            (FRLG_FLAGS_START + 122)
#define FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_M_DOLL            (FRLG_FLAGS_START + 123)
#define FLAG_HIDE_LORELEIS_HOUSE_FEAROW_DOLL               (FRLG_FLAGS_START + 124)
#define FLAG_HIDE_LORELEIS_HOUSE_PIDGEOT_DOLL              (FRLG_FLAGS_START + 125)
#define FLAG_HIDE_LORELEIS_HOUSE_LAPRAS_DOLL               (FRLG_FLAGS_START + 126)
#define FLAG_HIDE_MISC_KANTO_ROCKETS                       (FRLG_FLAGS_START + 127)
#define FLAG_HIDE_SAFFRON_CITY_POKECENTER_SABRINA_JOURNALS (FRLG_FLAGS_START + 128)

#define FLAG_HIDE_ROUTE2_ETHER                                  (FRLG_FLAGS_START + 129)
#define FLAG_HIDE_ROUTE2_PARALYZE_HEAL                          (FRLG_FLAGS_START + 130)
#define FLAG_HIDE_VIRIDIAN_FOREST_POKE_BALL                     (FRLG_FLAGS_START + 131)
#define FLAG_HIDE_VIRIDIAN_FOREST_ANTIDOTE                      (FRLG_FLAGS_START + 132)
#define FLAG_HIDE_VIRIDIAN_FOREST_POTION                        (FRLG_FLAGS_START + 133)
#define FLAG_HIDE_MT_MOON_1F_PARALYZE_HEAL                      (FRLG_FLAGS_START + 134)
#define FLAG_HIDE_MT_MOON_1F_TM09                               (FRLG_FLAGS_START + 135)
#define FLAG_HIDE_MT_MOON_1F_POTION                             (FRLG_FLAGS_START + 136)
#define FLAG_HIDE_MT_MOON_1F_RARE_CANDY                         (FRLG_FLAGS_START + 137)
#define FLAG_HIDE_MT_MOON_1F_ESCAPE_ROPE                        (FRLG_FLAGS_START + 138)
#define FLAG_HIDE_MT_MOON_1F_MOON_STONE                         (FRLG_FLAGS_START + 139)
#define FLAG_HIDE_MT_MOON_B2F_STAR_PIECE                        (FRLG_FLAGS_START + 140)
#define FLAG_HIDE_MT_MOON_B2F_TM46                              (FRLG_FLAGS_START + 141)
#define FLAG_HIDE_ROUTE4_TM05                                   (FRLG_FLAGS_START + 142)
#define FLAG_HIDE_ROUTE24_TM45                                  (FRLG_FLAGS_START + 143)
#define FLAG_HIDE_ROUTE25_TM43                                  (FRLG_FLAGS_START + 144)
#define FLAG_HIDE_SSANNE_1F_ROOM2_TM31                          (FRLG_FLAGS_START + 145)
#define FLAG_HIDE_SSANNE_2F_ROOM2_STARDUST                      (FRLG_FLAGS_START + 146)
#define FLAG_HIDE_SSANNE_2F_ROOM4_X_ATTACK                      (FRLG_FLAGS_START + 147)
#define FLAG_HIDE_SSANNE_B1F_ROOM2_TM44                         (FRLG_FLAGS_START + 148)
#define FLAG_HIDE_SSANNE_B1F_ROOM3_ETHER                        (FRLG_FLAGS_START + 149)
#define FLAG_HIDE_SSANNE_B1F_ROOM5_SUPER_POTION                 (FRLG_FLAGS_START + 150)
#define FLAG_HIDE_SSANNE_KITCHEN_GREAT_BALL                     (FRLG_FLAGS_START + 151)
#define FLAG_HIDE_ROUTE9_TM40                                   (FRLG_FLAGS_START + 152)
#define FLAG_HIDE_ROCKET_HIDEOUT_B1F_ESCAPE_ROPE                (FRLG_FLAGS_START + 153)
#define FLAG_HIDE_ROCKET_HIDEOUT_B1F_HYPER_POTION               (FRLG_FLAGS_START + 154)
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_X_SPEED                    (FRLG_FLAGS_START + 155)
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_MOON_STONE                 (FRLG_FLAGS_START + 156)
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_TM12                       (FRLG_FLAGS_START + 157)
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_SUPER_POTION               (FRLG_FLAGS_START + 158)
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_RARE_CANDY                 (FRLG_FLAGS_START + 159)
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_TM21                       (FRLG_FLAGS_START + 160)
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_TM49                       (FRLG_FLAGS_START + 161)
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_MAX_ETHER                  (FRLG_FLAGS_START + 162)
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_CALCIUM                    (FRLG_FLAGS_START + 163)
#define FLAG_HIDE_POKEMON_TOWER_3F_ESCAPE_ROPE                  (FRLG_FLAGS_START + 164)
#define FLAG_HIDE_POKEMON_TOWER_4F_ELIXIR                       (FRLG_FLAGS_START + 165)
#define FLAG_HIDE_POKEMON_TOWER_4F_AWAKENING                    (FRLG_FLAGS_START + 166)
#define FLAG_HIDE_POKEMON_TOWER_4F_GREAT_BALL                   (FRLG_FLAGS_START + 167)
#define FLAG_HIDE_POKEMON_TOWER_5F_NUGGET                       (FRLG_FLAGS_START + 168)
#define FLAG_HIDE_POKEMON_TOWER_6F_RARE_CANDY                   (FRLG_FLAGS_START + 169)
#define FLAG_HIDE_POKEMON_TOWER_6F_X_ACCURACY                   (FRLG_FLAGS_START + 170)
#define FLAG_HIDE_ROUTE12_TM48                                  (FRLG_FLAGS_START + 171)
#define FLAG_HIDE_ROUTE12_IRON                                  (FRLG_FLAGS_START + 172)
#define FLAG_HIDE_ROUTE15_TM18                                  (FRLG_FLAGS_START + 173)
#define FLAG_HIDE_SAFARI_ZONE_CENTER_NUGGET                     (FRLG_FLAGS_START + 174)
#define FLAG_HIDE_SAFARI_ZONE_EAST_MAX_POTION                   (FRLG_FLAGS_START + 175)
#define FLAG_HIDE_SAFARI_ZONE_EAST_FULL_RESTORE                 (FRLG_FLAGS_START + 176)
#define FLAG_HIDE_SAFARI_ZONE_EAST_TM11                         (FRLG_FLAGS_START + 177)
#define FLAG_HIDE_SAFARI_ZONE_EAST_LEAF_STONE                   (FRLG_FLAGS_START + 178)
#define FLAG_HIDE_SAFARI_ZONE_NORTH_PROTEIN                     (FRLG_FLAGS_START + 179)
#define FLAG_HIDE_SAFARI_ZONE_NORTH_TM47                        (FRLG_FLAGS_START + 180)
#define FLAG_HIDE_SAFARI_ZONE_WEST_TM32                         (FRLG_FLAGS_START + 181)
#define FLAG_HIDE_SAFARI_ZONE_WEST_GOLD_TEETH                   (FRLG_FLAGS_START + 182)
#define FLAG_HIDE_SAFARI_ZONE_WEST_MAX_POTION                   (FRLG_FLAGS_START + 183)
#define FLAG_HIDE_SAFARI_ZONE_WEST_MAX_REVIVE                   (FRLG_FLAGS_START + 184)
#define FLAG_HIDE_SILPH_CO_3F_HYPER_POTION                      (FRLG_FLAGS_START + 185)
#define FLAG_HIDE_SILPH_CO_4F_MAX_REVIVE                        (FRLG_FLAGS_START + 186)
#define FLAG_HIDE_SILPH_CO_4F_ESCAPE_ROPE                       (FRLG_FLAGS_START + 187)
#define FLAG_HIDE_SILPH_CO_4F_FULL_HEAL                         (FRLG_FLAGS_START + 188)
#define FLAG_HIDE_SILPH_CO_5F_PROTEIN                           (FRLG_FLAGS_START + 189)
#define FLAG_HIDE_SILPH_CO_5F_TM01                              (FRLG_FLAGS_START + 190)
#define FLAG_HIDE_SILPH_CO_5F_CARD_KEY                          (FRLG_FLAGS_START + 191)
#define FLAG_HIDE_SILPH_CO_6F_HP_UP                             (FRLG_FLAGS_START + 192)
#define FLAG_HIDE_SILPH_CO_6F_X_SPECIAL                         (FRLG_FLAGS_START + 193)
#define FLAG_HIDE_SILPH_CO_7F_CALCIUM                           (FRLG_FLAGS_START + 194)
#define FLAG_HIDE_SILPH_CO_7F_TM08                              (FRLG_FLAGS_START + 195)
#define FLAG_HIDE_SILPH_CO_10F_CARBOS                           (FRLG_FLAGS_START + 196)
#define FLAG_HIDE_SILPH_CO_10F_ULTRA_BALL                       (FRLG_FLAGS_START + 197)
#define FLAG_HIDE_SILPH_CO_10F_RARE_CANDY                       (FRLG_FLAGS_START + 198)
#define FLAG_HIDE_POWER_PLANT_MAX_POTION                        (FRLG_FLAGS_START + 199)
#define FLAG_HIDE_POWER_PLANT_TM17                              (FRLG_FLAGS_START + 200)
#define FLAG_HIDE_POWER_PLANT_TM25                              (FRLG_FLAGS_START + 201)
#define FLAG_HIDE_POWER_PLANT_THUNDER_STONE                     (FRLG_FLAGS_START + 202)
#define FLAG_HIDE_POWER_PLANT_ELIXIR                            (FRLG_FLAGS_START + 203)
#define FLAG_HIDE_POKEMON_MANSION_1F_CARBOS                     (FRLG_FLAGS_START + 204)
#define FLAG_HIDE_POKEMON_MANSION_1F_ESCAPE_ROPE                (FRLG_FLAGS_START + 205)
#define FLAG_HIDE_POKEMON_MANSION_2F_CALCIUM                    (FRLG_FLAGS_START + 206)
#define FLAG_HIDE_POKEMON_MANSION_3F_MAX_POTION                 (FRLG_FLAGS_START + 207)
#define FLAG_HIDE_POKEMON_MANSION_3F_IRON                       (FRLG_FLAGS_START + 208)
#define FLAG_HIDE_POKEMON_MANSION_B1F_TM14                      (FRLG_FLAGS_START + 209)
#define FLAG_HIDE_POKEMON_MANSION_B1F_FULL_RESTORE              (FRLG_FLAGS_START + 210)
#define FLAG_0x1A6                                              0
#define FLAG_HIDE_POKEMON_MANSION_B1F_TM22                      (FRLG_FLAGS_START + 211)
#define FLAG_HIDE_POKEMON_MANSION_B1F_SECRET_KEY                (FRLG_FLAGS_START + 212)
#define FLAG_HIDE_VICTORY_ROAD_1F_RARE_CANDY                    (FRLG_FLAGS_START + 213)
#define FLAG_HIDE_VICTORY_ROAD_1F_TM02                          (FRLG_FLAGS_START + 214)
#define FLAG_HIDE_VICTORY_ROAD_2F_GUARD_SPEC                    (FRLG_FLAGS_START + 215)
#define FLAG_HIDE_VICTORY_ROAD_2F_TM07                          (FRLG_FLAGS_START + 216)
#define FLAG_HIDE_VICTORY_ROAD_2F_FULL_HEAL                     (FRLG_FLAGS_START + 217)
#define FLAG_HIDE_VICTORY_ROAD_2F_TM37                          (FRLG_FLAGS_START + 218)
#define FLAG_HIDE_VICTORY_ROAD_3F_MAX_REVIVE                    (FRLG_FLAGS_START + 219)
#define FLAG_HIDE_VICTORY_ROAD_3F_TM50                          (FRLG_FLAGS_START + 220)
#define FLAG_HIDE_CERULEAN_CAVE_1F_MAX_ELIXIR                   (FRLG_FLAGS_START + 221)
#define FLAG_HIDE_CERULEAN_CAVE_1F_NUGGET                       (FRLG_FLAGS_START + 222)
#define FLAG_HIDE_CERULEAN_CAVE_1F_FULL_RESTORE                 (FRLG_FLAGS_START + 223)
#define FLAG_HIDE_CERULEAN_CAVE_2F_FULL_RESTORE                 (FRLG_FLAGS_START + 224)
#define FLAG_HIDE_CERULEAN_CAVE_2F_PP_UP                        (FRLG_FLAGS_START + 225)
#define FLAG_HIDE_CERULEAN_CAVE_2F_ULTRA_BALL                   (FRLG_FLAGS_START + 226)
#define FLAG_HIDE_CERULEAN_CAVE_B1F_MAX_REVIVE                  (FRLG_FLAGS_START + 227)
#define FLAG_HIDE_CERULEAN_CAVE_B1F_ULTRA_BALL                  (FRLG_FLAGS_START + 228)
#define FLAG_HIDE_FUCHSIA_CITY_WARDENS_HOUSE_RARE_CANDY         (FRLG_FLAGS_START + 229)
#define FLAG_HIDE_TWO_ISLAND_REVIVE                             (FRLG_FLAGS_START + 230)
#define FLAG_HIDE_THREE_ISLAND_ZINC                             (FRLG_FLAGS_START + 231)
#define FLAG_0x1BC                                              0
#define FLAG_0x1BD                                              0
#define FLAG_HIDE_VIRIDIAN_FOREST_POTION_2                      (FRLG_FLAGS_START + 232)
#define FLAG_HIDE_MT_MOON_B2F_REVIVE                            (FRLG_FLAGS_START + 233)
#define FLAG_HIDE_MT_MOON_B2F_ANTIDOTE                          (FRLG_FLAGS_START + 234)
#define FLAG_HIDE_ROUTE11_X_DEFEND                              (FRLG_FLAGS_START + 235)
#define FLAG_HIDE_ROUTE9_BURN_HEAL                              (FRLG_FLAGS_START + 236)
#define FLAG_HIDE_ROCK_TUNNEL_1F_REPEL                          (FRLG_FLAGS_START + 237)
#define FLAG_HIDE_ROCK_TUNNEL_1F_PEARL                          (FRLG_FLAGS_START + 238)
#define FLAG_HIDE_ROCK_TUNNEL_1F_ESCAPE_ROPE                    (FRLG_FLAGS_START + 239)
#define FLAG_HIDE_ROCK_TUNNEL_B1F_REVIVE                        (FRLG_FLAGS_START + 240)
#define FLAG_HIDE_ROCK_TUNNEL_B1F_MAX_ETHER                     (FRLG_FLAGS_START + 241)
#define FLAG_HIDE_SILPH_CO_8F_IRON                              (FRLG_FLAGS_START + 242)
#define FLAG_HIDE_SILPH_CO_11F_ZINC                             (FRLG_FLAGS_START + 243)
#define FLAG_HIDE_POKEMON_MANSION_1F_PROTEIN                    (FRLG_FLAGS_START + 244)
#define FLAG_HIDE_POKEMON_MANSION_2F_ZINC                       (FRLG_FLAGS_START + 245)
#define FLAG_HIDE_POKEMON_MANSION_2F_HP_UP                      (FRLG_FLAGS_START + 246)
#define FLAG_HIDE_VIRIDIAN_CITY_POTION                          (FRLG_FLAGS_START + 247)
#define FLAG_HIDE_ROUTE11_GREAT_BALL                            (FRLG_FLAGS_START + 248)
#define FLAG_HIDE_ROUTE11_AWAKENING                             (FRLG_FLAGS_START + 249)
#define FLAG_HIDE_POKEMON_TOWER_5F_CLEANSE_TAG                  (FRLG_FLAGS_START + 250)
#define FLAG_HIDE_CELADON_CITY_ETHER                            (FRLG_FLAGS_START + 251)
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_BLACK_GLASSES              (FRLG_FLAGS_START + 252)
#define FLAG_HIDE_SAFARI_ZONE_NORTH_QUICK_CLAW                  (FRLG_FLAGS_START + 253)
#define FLAG_HIDE_SEAFOAM_ISLANDS_1F_ICE_HEAL                   (FRLG_FLAGS_START + 254)
#define FLAG_HIDE_SEAFOAM_ISLANDS_B1F_WATER_STONE               (FRLG_FLAGS_START + 255)
#define FLAG_HIDE_SEAFOAM_ISLANDS_B1F_REVIVE                    (FRLG_FLAGS_START + 256)
#define FLAG_HIDE_SEAFOAM_ISLANDS_B2F_BIG_PEARL                 (FRLG_FLAGS_START + 257)
#define FLAG_HIDE_SEAFOAM_ISLANDS_B4F_ULTRA_BALL                (FRLG_FLAGS_START + 258)
#define FLAG_HIDE_FOUR_ISLAND_STAR_PIECE                        (FRLG_FLAGS_START + 259)
#define FLAG_HIDE_FOUR_ISLAND_STARDUST                          (FRLG_FLAGS_START + 260)
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_ETHER                  (FRLG_FLAGS_START + 261)
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_MAX_REPEL              (FRLG_FLAGS_START + 262)
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_CARBOS                 (FRLG_FLAGS_START + 263)
#define FLAG_HIDE_FIVE_ISLAND_MEADOW_MAX_POTION                 (FRLG_FLAGS_START + 264)
#define FLAG_HIDE_FIVE_ISLAND_MEADOW_PP_UP                      (FRLG_FLAGS_START + 265)
#define FLAG_HIDE_FIVE_ISLAND_MEMORIAL_PILLAR_METAL_COAT        (FRLG_FLAGS_START + 266)
#define FLAG_HIDE_SIX_ISLAND_OUTCAST_ISLAND_PP_UP               (FRLG_FLAGS_START + 267)
#define FLAG_HIDE_SIX_ISLAND_WATER_PATH_ELIXIR                  (FRLG_FLAGS_START + 268)
#define FLAG_HIDE_SIX_ISLAND_WATER_PATH_DRAGON_SCALE            (FRLG_FLAGS_START + 269)
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_FULL_RESTORE           (FRLG_FLAGS_START + 270)
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_HP_UP                  (FRLG_FLAGS_START + 271)
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_SUN_STONE              (FRLG_FLAGS_START + 272)
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_KINGS_ROCK        (FRLG_FLAGS_START + 273)
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_MAX_ELIXIR        (FRLG_FLAGS_START + 274)
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_NUGGET            (FRLG_FLAGS_START + 275)
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ETHER           (FRLG_FLAGS_START + 276)
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_FULL_HEAL           (FRLG_FLAGS_START + 277)
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ELIXIR          (FRLG_FLAGS_START + 278)
#define FLAG_HIDE_MT_EMBER_EXTERIOR_ULTRA_BALL                  (FRLG_FLAGS_START + 279)
#define FLAG_HIDE_MT_EMBER_EXTERIOR_FIRE_STONE                  (FRLG_FLAGS_START + 280)
#define FLAG_HIDE_MT_EMBER_EXTERIOR_DIRE_HIT                    (FRLG_FLAGS_START + 281)
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_ULTRA_BALL        (FRLG_FLAGS_START + 282)
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_HM07              (FRLG_FLAGS_START + 283)
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_FULL_RESTORE     (FRLG_FLAGS_START + 284)
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_NEVER_MELT_ICE   (FRLG_FLAGS_START + 285)
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_BIG_PEARL        (FRLG_FLAGS_START + 286)
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_TM36             (FRLG_FLAGS_START + 287)
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_PEARL            (FRLG_FLAGS_START + 288)
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_UP_GRADE         (FRLG_FLAGS_START + 289)
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM10_SILK_SCARF       (FRLG_FLAGS_START + 290)
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM11_LAX_INCENSE      (FRLG_FLAGS_START + 291)
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM12_SEA_INCENSE      (FRLG_FLAGS_START + 292)
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM13_MAX_REVIVE       (FRLG_FLAGS_START + 293)
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM14_RARE_CANDY       (FRLG_FLAGS_START + 294)
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_HOUSE_LUCKY_PUNCH (FRLG_FLAGS_START + 295)
#define FLAG_HIDE_SILPH_CO_4F_TM41                              (FRLG_FLAGS_START + 296)

#define STORY_FLAGS_START                                0
#define FLAG_GOT_POTION_ON_ROUTE_1                       (FRLG_FLAGS_START + 297)
#define FLAG_GOT_TM34_FROM_SURGE                         (FRLG_FLAGS_START + 298)
#define FLAG_GOT_FOSSIL_FROM_MT_MOON                     (FRLG_FLAGS_START + 299)
#define FLAG_HELPED_BILL_IN_SEA_COTTAGE                  (FRLG_FLAGS_START + 300)
#define FLAG_GOT_SS_TICKET                               (FRLG_FLAGS_START + 301)
#define FLAG_GOT_SS_TICKET_DUP                           (FRLG_FLAGS_START + 302)
#define FLAG_GOT_TM42_AT_MEMORIAL_PILLAR                 (FRLG_FLAGS_START + 303)
#define FLAG_GOT_HM01                                    (FRLG_FLAGS_START + 304)
#define FLAG_GOT_HM02                                    (FRLG_FLAGS_START + 305)
#define FLAG_GOT_HM03                                    (FRLG_FLAGS_START + 306)
#define FLAG_GOT_HM04                                    (FRLG_FLAGS_START + 307)
#define FLAG_GOT_HM05                                    (FRLG_FLAGS_START + 308)
#define FLAG_RESCUED_MR_FUJI                             (FRLG_FLAGS_START + 309)
#define FLAG_GOT_POKE_FLUTE                              (FRLG_FLAGS_START + 310)
#define FLAG_0x23E                                       0
#define FLAG_GOT_TM28_FROM_ROCKET                        (FRLG_FLAGS_START + 311)
#define FLAG_GOT_OLD_ROD                                 (FRLG_FLAGS_START + 312)
#define FLAG_GOT_BIKE_VOUCHER                            (FRLG_FLAGS_START + 313)
#define FLAG_0x242                                       0
#define FLAG_GOT_COIN_CASE                               (FRLG_FLAGS_START + 314)
#define FLAG_GOT_GOOD_ROD                                (FRLG_FLAGS_START + 315)
#define FLAG_GOT_TM29_FROM_MR_PSYCHIC                    (FRLG_FLAGS_START + 316)
#define FLAG_GOT_LAPRAS_FROM_SILPH                       (FRLG_FLAGS_START + 317)
#define FLAG_GOT_POKEBALLS_FROM_OAK_AFTER_22_RIVAL       (FRLG_FLAGS_START + 318)
#define FLAG_DID_MIMIEN_TRADE                            (FRLG_FLAGS_START + 319)
#define FLAG_BOUGHT_MAGIKARP                             (FRLG_FLAGS_START + 320)
#define FLAG_DID_ZYNX_TRADE                              (FRLG_FLAGS_START + 321)
#define FLAG_DID_MS_NIDO_TRADE                           (FRLG_FLAGS_START + 322)
#define FLAG_0x24C                                       0
#define FLAG_DID_CH_DING_TRADE                           (FRLG_FLAGS_START + 323)
#define FLAG_GOT_TM38_FROM_BLAINE                        (FRLG_FLAGS_START + 324)
#define FLAG_OAK_SKIP_22_RIVAL_CHECK                     (FRLG_FLAGS_START + 325)
#define FLAG_GOT_MASTER_BALL_FROM_SILPH                  (FRLG_FLAGS_START + 326)
#define FLAG_DID_NINA_TRADE                              (FRLG_FLAGS_START + 327)
#define FLAG_GOT_ITEMFINDER                              (FRLG_FLAGS_START + 328)
#define FLAG_WOKE_UP_ROUTE_12_SNORLAX                    (FRLG_FLAGS_START + 329)
#define FLAG_GOT_TM39_FROM_BROCK                         (FRLG_FLAGS_START + 330)
#define FLAG_GOT_SUPER_ROD                               (FRLG_FLAGS_START + 331)
#define FLAG_GOT_EXP_SHARE_FROM_OAKS_AIDE                (FRLG_FLAGS_START + 332)
#define FLAG_DID_MARC_TRADE                              (FRLG_FLAGS_START + 333)
#define FLAG_BEAT_RIVAL_IN_OAKS_LAB                      (FRLG_FLAGS_START + 334)
#define FLAG_GOT_TM06_FROM_KOGA                          (FRLG_FLAGS_START + 335)
#define FLAG_0x25A                                       0
#define FLAG_GOT_TM27                                    (FRLG_FLAGS_START + 336)
#define FLAG_0x25C                                       0
#define FLAG_0x25D                                       0
#define FLAG_GOT_OLD_AMBER                               (FRLG_FLAGS_START + 337)
#define FLAG_0x25F                                       0
#define FLAG_0x260                                       0
#define FLAG_0x261                                       0
#define FLAG_0x262                                       0
#define FLAG_GOT_EEVEE                                   (FRLG_FLAGS_START + 338)
#define FLAG_FOUND_BOTH_VERMILION_GYM_SWITCHES           (FRLG_FLAGS_START + 339)
#define FLAG_CINNABAR_GYM_QUIZ_1                         (FRLG_FLAGS_START + 340)
#define FLAG_CINNABAR_GYM_QUIZ_2                         (FRLG_FLAGS_START + 341)
#define FLAG_CINNABAR_GYM_QUIZ_3                         (FRLG_FLAGS_START + 342)
#define FLAG_CINNABAR_GYM_QUIZ_4                         (FRLG_FLAGS_START + 343)
#define FLAG_CINNABAR_GYM_QUIZ_5                         (FRLG_FLAGS_START + 344)
#define FLAG_CINNABAR_GYM_QUIZ_6                         (FRLG_FLAGS_START + 345)
#define FLAG_POKEMON_MANSION_SWITCH_STATE                (FRLG_FLAGS_START + 346)
#define FLAG_OPENED_ROCKET_HIDEOUT                       (FRLG_FLAGS_START + 347)
#define FLAG_GOT_10_COINS_FROM_GAMBLER                   (FRLG_FLAGS_START + 348)
#define FLAG_GOT_20_COINS_FROM_GAMBLER                   (FRLG_FLAGS_START + 349)
#define FLAG_GOT_20_COINS_FROM_GAMBLER_2                 (FRLG_FLAGS_START + 350)
#define FLAG_GOT_BICYCLE                                 (FRLG_FLAGS_START + 351)
#define FLAG_GOT_DOME_FOSSIL                             (FRLG_FLAGS_START + 352)
#define FLAG_GOT_HELIX_FOSSIL                            (FRLG_FLAGS_START + 353)
#define FLAG_DID_ESPHERE_TRADE                           (FRLG_FLAGS_START + 354)
#define FLAG_DID_TANGENY_TRADE                           (FRLG_FLAGS_START + 355)
#define FLAG_DID_SEELOR_TRADE                            (FRLG_FLAGS_START + 356)
#define FLAG_0x277                                       0
#define FLAG_GOT_HITMON_FROM_DOJO                        (FRLG_FLAGS_START + 357)
#define FLAG_0x279                                       0
#define FLAG_SILPH_2F_DOOR_1                             (FRLG_FLAGS_START + 358)
#define FLAG_SILPH_2F_DOOR_2                             (FRLG_FLAGS_START + 359)
#define FLAG_SILPH_3F_DOOR_1                             (FRLG_FLAGS_START + 360)
#define FLAG_SILPH_3F_DOOR_2                             (FRLG_FLAGS_START + 361)
#define FLAG_SILPH_4F_DOOR_1                             (FRLG_FLAGS_START + 362)
#define FLAG_SILPH_4F_DOOR_2                             (FRLG_FLAGS_START + 363)
#define FLAG_SILPH_5F_DOOR_1                             (FRLG_FLAGS_START + 364)
#define FLAG_SILPH_5F_DOOR_2                             (FRLG_FLAGS_START + 365)
#define FLAG_SILPH_5F_DOOR_3                             (FRLG_FLAGS_START + 366)
#define FLAG_SILPH_6F_DOOR                               (FRLG_FLAGS_START + 367)
#define FLAG_SILPH_7F_DOOR_1                             (FRLG_FLAGS_START + 368)
#define FLAG_SILPH_7F_DOOR_2                             (FRLG_FLAGS_START + 369)
#define FLAG_SILPH_7F_DOOR_3                             (FRLG_FLAGS_START + 370)
#define FLAG_SILPH_8F_DOOR                               (FRLG_FLAGS_START + 371)
#define FLAG_SILPH_9F_DOOR_1                             (FRLG_FLAGS_START + 372)
#define FLAG_SILPH_9F_DOOR_2                             (FRLG_FLAGS_START + 373)
#define FLAG_SILPH_9F_DOOR_3                             (FRLG_FLAGS_START + 374)
#define FLAG_SILPH_9F_DOOR_4                             (FRLG_FLAGS_START + 375)
#define FLAG_SILPH_10F_DOOR                              (FRLG_FLAGS_START + 376)
#define FLAG_SILPH_11F_DOOR                              (FRLG_FLAGS_START + 377)
#define FLAG_0x28E                                       0
#define FLAG_0x28F                                       0
#define FLAG_MET_STICKER_MAN                             (FRLG_FLAGS_START + 378)
#define FLAG_PALLET_LADY_NOT_BLOCKING_SIGN               (FRLG_FLAGS_START + 379)
#define FLAG_GOT_VS_SEEKER                               (FRLG_FLAGS_START + 380)
#define FLAG_GOT_TM19_FROM_ERIKA                         (FRLG_FLAGS_START + 381)
#define FLAG_GOT_TM33_FROM_THIRSTY_GIRL                  (FRLG_FLAGS_START + 382)
#define FLAG_GOT_TM20_FROM_THIRSTY_GIRL                  (FRLG_FLAGS_START + 383)
#define FLAG_GOT_TM16_FROM_THIRSTY_GIRL                  (FRLG_FLAGS_START + 384)
#define FLAG_GOT_TM03_FROM_MISTY                         (FRLG_FLAGS_START + 385)
#define FLAG_GOT_TM26_FROM_GIOVANNI                      (FRLG_FLAGS_START + 386)
#define FLAG_0x299                                       0
#define FLAG_GOT_TM04_FROM_SABRINA                       (FRLG_FLAGS_START + 387)
#define FLAG_GOT_FAME_CHECKER                            (FRLG_FLAGS_START + 388)
#define FLAG_GOT_RECORD_SETTING_MAGIKARP                 (FRLG_FLAGS_START + 389)
#define FLAG_TWO_ISLAND_SHOP_INTRODUCED                  (FRLG_FLAGS_START + 390)
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_1                  (FRLG_FLAGS_START + 391)
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_2                  (FRLG_FLAGS_START + 392)
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_3                  (FRLG_FLAGS_START + 393)
#define FLAG_SEVII_DETOUR_FINISHED                       (FRLG_FLAGS_START + 394)
#define FLAG_VISITED_TWO_ISLAND                          (FRLG_FLAGS_START + 395)
#define FLAG_RESCUED_LOSTELLE                            (FRLG_FLAGS_START + 396)
#define FLAG_0x2A4                                       0
#define FLAG_CAN_USE_ROCKET_HIDEOUT_LIFT                 (FRLG_FLAGS_START + 397)
#define FLAG_GOT_TEA                                     (FRLG_FLAGS_START + 398)
#define FLAG_GOT_POWDER_JAR                              (FRLG_FLAGS_START + 399)
#define FLAG_FOUGHT_MEWTWO                               (FRLG_FLAGS_START + 400)
#define FLAG_FOUGHT_MOLTRES                              (FRLG_FLAGS_START + 401)
#define FLAG_FOUGHT_ARTICUNO                             (FRLG_FLAGS_START + 402)
#define FLAG_FOUGHT_ZAPDOS                               (FRLG_FLAGS_START + 403)
#define FLAG_TUTOR_DOUBLE_EDGE                           (FRLG_FLAGS_START + 404)
#define FLAG_TUTOR_THUNDER_WAVE                          (FRLG_FLAGS_START + 405)
#define FLAG_TUTOR_ROCK_SLIDE                            (FRLG_FLAGS_START + 406)
#define FLAG_TUTOR_EXPLOSION                             (FRLG_FLAGS_START + 407)
#define FLAG_TUTOR_MEGA_PUNCH                            (FRLG_FLAGS_START + 408)
#define FLAG_TUTOR_MEGA_KICK                             (FRLG_FLAGS_START + 409)
#define FLAG_TUTOR_DREAM_EATER                           (FRLG_FLAGS_START + 410)
#define FLAG_TUTOR_SOFT_BOILED                           (FRLG_FLAGS_START + 411)
#define FLAG_TUTOR_SUBSTITUTE                            (FRLG_FLAGS_START + 412)
#define FLAG_TUTOR_SWORDS_DANCE                          (FRLG_FLAGS_START + 413)
#define FLAG_TUTOR_SEISMIC_TOSS                          (FRLG_FLAGS_START + 414)
#define FLAG_TUTOR_COUNTER                               (FRLG_FLAGS_START + 415)
#define FLAG_TUTOR_METRONOME                             (FRLG_FLAGS_START + 416)
#define FLAG_TUTOR_MIMIC                                 (FRLG_FLAGS_START + 417)
#define FLAG_TUTOR_BODY_SLAM                             (FRLG_FLAGS_START + 418)
#define FLAG_VISITED_OAKS_LAB                            (FRLG_FLAGS_START + 419)
#define FLAG_FOUGHT_POWER_PLANT_ELECTRODE_1              (FRLG_FLAGS_START + 420)
#define FLAG_FOUGHT_POWER_PLANT_ELECTRODE_2              (FRLG_FLAGS_START + 421)
#define FLAG_STOPPED_SEAFOAM_B3F_CURRENT                 (FRLG_FLAGS_START + 422)
#define FLAG_STOPPED_SEAFOAM_B4F_CURRENT                 (FRLG_FLAGS_START + 423)
#define FLAG_TALKED_TO_LORELEI_AFTER_WAREHOUSE           (FRLG_FLAGS_START + 424)
#define FLAG_DEFEATED_ROCKETS_IN_WAREHOUSE               (FRLG_FLAGS_START + 425)
#define FLAG_UNLOCKED_ROCKET_WAREHOUSE                   (FRLG_FLAGS_START + 426)
#define FLAG_NO_ROOM_FOR_TM42_AT_MEMORIAL_PILLAR         (FRLG_FLAGS_START + 427)
#define FLAG_LEARNED_YES_NAH_CHANSEY                     (FRLG_FLAGS_START + 428)
#define FLAG_GOT_NEST_BALL_FROM_WATER_PATH_HOUSE_1       (FRLG_FLAGS_START + 429)
#define FLAG_GOT_TOGEPI_EGG                              (FRLG_FLAGS_START + 430)
#define FLAG_NO_ROOM_FOR_TOGEPI_EGG                      (FRLG_FLAGS_START + 431)
#define FLAG_RECOVERED_SAPPHIRE                          (FRLG_FLAGS_START + 432)
#define FLAG_GOT_RUBY                                    (FRLG_FLAGS_START + 433)
#define FLAG_TUTOR_FRENZY_PLANT                          (FRLG_FLAGS_START + 434)
#define FLAG_TUTOR_BLAST_BURN                            (FRLG_FLAGS_START + 435)
#define FLAG_TUTOR_HYDRO_CANNON                          (FRLG_FLAGS_START + 436)
#define FLAG_LEARNED_ALL_MOVES_AT_CAPE_BRINK             (FRLG_FLAGS_START + 437)
#define FLAG_GOT_NUGGET_FROM_DUNSPARCE_TUNNEL            (FRLG_FLAGS_START + 438)
#define FLAG_USED_CUT_ON_RUIN_VALLEY_BRAILLE             (FRLG_FLAGS_START + 439)
#define FLAG_FOUGHT_DEOXYS                               (FRLG_FLAGS_START + 440)
#define FLAG_0x2E5                                       0
#define FLAG_0x2E6                                       0
#define FLAG_0x2E7                                       0
#define FLAG_0x2E8                                       0
...
#define FLAG_0x2EA                                       0
#define FLAG_0x2EB                                       0
#define FLAG_REVIVED_DOME                                (FRLG_FLAGS_START + 441)
#define FLAG_REVIVED_HELIX                               (FRLG_FLAGS_START + 442)
#define FLAG_REVIVED_AMBER                               (FRLG_FLAGS_START + 443)
#define FLAG_GOT_HM06                                    (FRLG_FLAGS_START + 444)
#define FLAG_FOUGHT_LUGIA                                (FRLG_FLAGS_START + 445)
#define FLAG_FOUGHT_HO_OH                                (FRLG_FLAGS_START + 446)
#define FLAG_OAK_SAW_DEX_COMPLETION                      (FRLG_FLAGS_START + 447)
#define FLAG_LUGIA_FLEW_AWAY                             (FRLG_FLAGS_START + 448)
#define FLAG_HO_OH_FLEW_AWAY                             (FRLG_FLAGS_START + 449)
#define FLAG_DEOXYS_FLEW_AWAY                            (FRLG_FLAGS_START + 450)
#define FLAG_TALKED_TO_TEA_LADY_AFTER_HOF                (FRLG_FLAGS_START + 451)
#define FLAG_TALKED_TO_OAKS_AIDE_IN_VERMILION            (FRLG_FLAGS_START + 452)
#define FLAG_GOT_EVERSTONE_FROM_OAKS_AIDE                (FRLG_FLAGS_START + 453)
#define FLAG_GOT_MOON_STONE_FROM_JOYFUL_GAME_CORNER      (FRLG_FLAGS_START + 454)
#define FLAG_GOT_FULL_RESTORE_FROM_THREE_ISLAND_DEFENDER (FRLG_FLAGS_START + 455)
#define FLAG_GOT_AMULET_COIN_FROM_OAKS_AIDE              (FRLG_FLAGS_START + 456)
#define FLAG_NO_ROOM_FOR_JOYFUL_GAME_CORNER_MOON_STONE   (FRLG_FLAGS_START + 457)
#define FLAG_OAKS_RATING_IS_VIA_PC                       (FRLG_FLAGS_START + 458)

#define FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_POTION                            (FRLG_FLAGS_START + 459)
#define FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_ANTIDOTE                          (FRLG_FLAGS_START + 460)
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_MOON_STONE                            (FRLG_FLAGS_START + 461)
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_ETHER                                 (FRLG_FLAGS_START + 462)
#define FLAG_HIDDEN_ITEM_ROUTE25_ELIXIR                                    (FRLG_FLAGS_START + 463)
#define FLAG_HIDDEN_ITEM_ROUTE25_ETHER                                     (FRLG_FLAGS_START + 464)
#define FLAG_HIDDEN_ITEM_ROUTE9_ETHER                                      (FRLG_FLAGS_START + 465)
#define FLAG_HIDDEN_ITEM_UNUSED_0x07                                       0
#define FLAG_HIDDEN_ITEM_SSANNE_B1F_CORRIDOR_HYPER_POTION                  (FRLG_FLAGS_START + 466)
#define FLAG_HIDDEN_ITEM_ROUTE10_SUPER_POTION                              (FRLG_FLAGS_START + 467)
#define FLAG_HIDDEN_ITEM_ROUTE10_MAX_ETHER                                 (FRLG_FLAGS_START + 468)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B1F_PP_UP                          (FRLG_FLAGS_START + 469)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B3F_NUGGET                         (FRLG_FLAGS_START + 470)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NEST_BALL                      (FRLG_FLAGS_START + 471)
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_5F_BIG_MUSHROOM                     (FRLG_FLAGS_START + 472)
#define FLAG_HIDDEN_ITEM_ROUTE13_PP_UP                                     (FRLG_FLAGS_START + 473)
#define FLAG_HIDDEN_ITEM_UNUSED_0x10                                       0
#define FLAG_HIDDEN_ITEM_ROUTE17_RARE_CANDY                                (FRLG_FLAGS_START + 474)
#define FLAG_HIDDEN_ITEM_ROUTE17_FULL_RESTORE                              (FRLG_FLAGS_START + 475)
#define FLAG_HIDDEN_ITEM_ROUTE17_PP_UP                                     (FRLG_FLAGS_START + 476)
#define FLAG_HIDDEN_ITEM_ROUTE17_MAX_REVIVE                                (FRLG_FLAGS_START + 477)
#define FLAG_HIDDEN_ITEM_ROUTE17_MAX_ELIXIR                                (FRLG_FLAGS_START + 478)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_CENTER_LEAF_STONE                     (FRLG_FLAGS_START + 479)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_WEST_REVIVE                           (FRLG_FLAGS_START + 480)
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_ELIXIR                                (FRLG_FLAGS_START + 481)
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_MAX_POTION                            (FRLG_FLAGS_START + 482)
#define FLAG_HIDDEN_ITEM_SAFFRON_CITY_COPYCATS_HOUSE_2F_NUGGET             (FRLG_FLAGS_START + 483)
#define FLAG_HIDDEN_ITEM_POWER_PLANT_MAX_ELIXIR                            (FRLG_FLAGS_START + 484)
#define FLAG_HIDDEN_ITEM_POWER_PLANT_THUNDER_STONE                         (FRLG_FLAGS_START + 485)
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B3F_NUGGET                        (FRLG_FLAGS_START + 486)
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B4F_WATER_STONE                   (FRLG_FLAGS_START + 487)
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_1F_MOON_STONE                     (FRLG_FLAGS_START + 488)
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_3F_RARE_CANDY                     (FRLG_FLAGS_START + 489)
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_B1F_ELIXIR                        (FRLG_FLAGS_START + 490)
#define FLAG_HIDDEN_ITEM_ROUTE23_FULL_RESTORE                              (FRLG_FLAGS_START + 491)
#define FLAG_HIDDEN_ITEM_ROUTE23_ULTRA_BALL                                (FRLG_FLAGS_START + 492)
#define FLAG_HIDDEN_ITEM_ROUTE23_MAX_ETHER                                 (FRLG_FLAGS_START + 493)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_FULL_RESTORE                      (FRLG_FLAGS_START + 494)
#define FLAG_HIDDEN_ITEM_CERULEAN_CAVE_1F_ULTRA_BALL                       (FRLG_FLAGS_START + 495)
#define FLAG_HIDDEN_ITEM_UNUSED_0x28                                       0
#define FLAG_HIDDEN_ITEM_ROUTE11_ESCAPE_ROPE                               (FRLG_FLAGS_START + 496)
#define FLAG_HIDDEN_ITEM_ROUTE12_HYPER_POTION                              (FRLG_FLAGS_START + 497)
...
#define FLAG_HIDDEN_ITEM_CELADON_CITY_PP_UP                                (FRLG_FLAGS_START + 498)
#define FLAG_HIDDEN_ITEM_VERMILION_CITY_MAX_ETHER                          (FRLG_FLAGS_START + 499)
#define FLAG_HIDDEN_ITEM_CERULEAN_CITY_RARE_CANDY                          (FRLG_FLAGS_START + 500)
#define FLAG_HIDDEN_ITEM_ROUTE4_GREAT_BALL                                 (FRLG_FLAGS_START + 501)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS                    (FRLG_FLAGS_START + 502)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_2                  (FRLG_FLAGS_START + 503)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_3                  (FRLG_FLAGS_START + 504)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_4                  (FRLG_FLAGS_START + 505)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_5                  (FRLG_FLAGS_START + 506)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_6                  (FRLG_FLAGS_START + 507)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_7                  (FRLG_FLAGS_START + 508)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_8                  (FRLG_FLAGS_START + 509)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_9                  (FRLG_FLAGS_START + 510)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_10                 (FRLG_FLAGS_START + 511)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_11                 (FRLG_FLAGS_START + 512)
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_12                 (FRLG_FLAGS_START + 513)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_CHERI_BERRY           (FRLG_FLAGS_START + 514)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_4           (FRLG_FLAGS_START + 515)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE             (FRLG_FLAGS_START + 516)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_2           (FRLG_FLAGS_START + 517)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_3           (FRLG_FLAGS_START + 518)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NEST_BALL            (FRLG_FLAGS_START + 519)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NET_BALL             (FRLG_FLAGS_START + 520)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_POTION        (FRLG_FLAGS_START + 521)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ANTIDOTE      (FRLG_FLAGS_START + 522)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_PARALYZE_HEAL (FRLG_FLAGS_START + 523)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_AWAKENING     (FRLG_FLAGS_START + 524)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_BURN_HEAL     (FRLG_FLAGS_START + 525)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ICE_HEAL      (FRLG_FLAGS_START + 526)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ETHER         (FRLG_FLAGS_START + 527)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_POTION          (FRLG_FLAGS_START + 528)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ANTIDOTE        (FRLG_FLAGS_START + 529)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_PARALYZE_HEAL   (FRLG_FLAGS_START + 530)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_AWAKENING       (FRLG_FLAGS_START + 531)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_BURN_HEAL       (FRLG_FLAGS_START + 532)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ICE_HEAL        (FRLG_FLAGS_START + 533)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ETHER           (FRLG_FLAGS_START + 534)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM                         (FRLG_FLAGS_START + 535)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_2                       (FRLG_FLAGS_START + 536)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_3                       (FRLG_FLAGS_START + 537)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM                          (FRLG_FLAGS_START + 538)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_2                        (FRLG_FLAGS_START + 539)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_3                        (FRLG_FLAGS_START + 540)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAZZ_BERRY              (FRLG_FLAGS_START + 541)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_BLUK_BERRY              (FRLG_FLAGS_START + 542)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_NANAB_BERRY             (FRLG_FLAGS_START + 543)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WEPEAR_BERRY            (FRLG_FLAGS_START + 544)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ORAN_BERRY              (FRLG_FLAGS_START + 545)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHERI_BERRY             (FRLG_FLAGS_START + 546)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY            (FRLG_FLAGS_START + 547)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY             (FRLG_FLAGS_START + 548)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY             (FRLG_FLAGS_START + 549)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ASPEAR_BERRY            (FRLG_FLAGS_START + 550)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY            (FRLG_FLAGS_START + 551)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PINAP_BERRY             (FRLG_FLAGS_START + 552)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_LUM_BERRY               (FRLG_FLAGS_START + 553)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST                (FRLG_FLAGS_START + 554)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST_2              (FRLG_FLAGS_START + 555)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL                   (FRLG_FLAGS_START + 556)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL_2                 (FRLG_FLAGS_START + 557)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL              (FRLG_FLAGS_START + 558)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL_2            (FRLG_FLAGS_START + 559)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STAR_PIECE              (FRLG_FLAGS_START + 560)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BIG_PEARL               (FRLG_FLAGS_START + 561)
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_RARE_CANDY                  (FRLG_FLAGS_START + 562)
#define FLAG_HIDDEN_ITEM_PEWTER_CITY_POKE_BALL                             (FRLG_FLAGS_START + 563)
#define FLAG_HIDDEN_ITEM_ROUTE3_ORAN_BERRY                                 (FRLG_FLAGS_START + 564)
#define FLAG_HIDDEN_ITEM_ROUTE4_PERSIM_BERRY                               (FRLG_FLAGS_START + 565)
#define FLAG_HIDDEN_ITEM_ROUTE24_PECHA_BERRY                               (FRLG_FLAGS_START + 566)
#define FLAG_HIDDEN_ITEM_ROUTE25_ORAN_BERRY                                (FRLG_FLAGS_START + 567)
#define FLAG_HIDDEN_ITEM_ROUTE25_BLUK_BERRY                                (FRLG_FLAGS_START + 568)
#define FLAG_HIDDEN_ITEM_ROUTE6_SITRUS_BERRY                               (FRLG_FLAGS_START + 569)
#define FLAG_HIDDEN_ITEM_ROUTE6_RARE_CANDY                                 (FRLG_FLAGS_START + 570)
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_PECHA_BERRY                        (FRLG_FLAGS_START + 571)
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHERI_BERRY                        (FRLG_FLAGS_START + 572)
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHESTO_BERRY                       (FRLG_FLAGS_START + 573)
#define FLAG_HIDDEN_ITEM_ROUTE9_RARE_CANDY                                 (FRLG_FLAGS_START + 574)
#define FLAG_HIDDEN_ITEM_UNUSED_0x7C                                       0
#define FLAG_HIDDEN_ITEM_ROUTE10_PERSIM_BERRY                              (FRLG_FLAGS_START + 575)
#define FLAG_HIDDEN_ITEM_ROUTE10_CHERI_BERRY                               (FRLG_FLAGS_START + 576)
#define FLAG_HIDDEN_ITEM_ROUTE8_RAWST_BERRY                                (FRLG_FLAGS_START + 577)
#define FLAG_HIDDEN_ITEM_ROUTE8_LUM_BERRY                                  (FRLG_FLAGS_START + 578)
#define FLAG_HIDDEN_ITEM_ROUTE8_LEPPA_BERRY                                (FRLG_FLAGS_START + 579)
#define FLAG_HIDDEN_ITEM_ROUTE12_RARE_CANDY                                (FRLG_FLAGS_START + 580)
#define FLAG_HIDDEN_ITEM_ROUTE12_LEFTOVERS                                 (FRLG_FLAGS_START + 581)
#define FLAG_HIDDEN_ITEM_ROUTE16_LEFTOVERS                                 (FRLG_FLAGS_START + 582)
#define FLAG_HIDDEN_ITEM_FUCHSIA_CITY_MAX_REVIVE                           (FRLG_FLAGS_START + 583)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NET_BALL                       (FRLG_FLAGS_START + 584)
#define FLAG_HIDDEN_ITEM_SILPH_CO_2F_ULTRA_BALL                            (FRLG_FLAGS_START + 585)
#define FLAG_HIDDEN_ITEM_SILPH_CO_3F_PROTEIN                               (FRLG_FLAGS_START + 586)
#define FLAG_HIDDEN_ITEM_SILPH_CO_4F_IRON                                  (FRLG_FLAGS_START + 587)
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_PP_UP                                 (FRLG_FLAGS_START + 588)
#define FLAG_HIDDEN_ITEM_SILPH_CO_6F_CARBOS                                (FRLG_FLAGS_START + 589)
#define FLAG_HIDDEN_ITEM_SILPH_CO_7F_ZINC                                  (FRLG_FLAGS_START + 590)
#define FLAG_HIDDEN_ITEM_SILPH_CO_8F_NUGGET                                (FRLG_FLAGS_START + 591)
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_CALCIUM                               (FRLG_FLAGS_START + 592)
#define FLAG_HIDDEN_ITEM_SILPH_CO_10F_HP_UP                                (FRLG_FLAGS_START + 593)
#define FLAG_HIDDEN_ITEM_SILPH_CO_11F_REVIVE                               (FRLG_FLAGS_START + 594)
#define FLAG_HIDDEN_ITEM_ROUTE23_LUM_BERRY                                 (FRLG_FLAGS_START + 595)
#define FLAG_HIDDEN_ITEM_ROUTE23_SITRUS_BERRY                              (FRLG_FLAGS_START + 596)
#define FLAG_HIDDEN_ITEM_ROUTE23_ASPEAR_BERRY                              (FRLG_FLAGS_START + 597)
#define FLAG_HIDDEN_ITEM_ROUTE23_LEPPA_BERRY                               (FRLG_FLAGS_START + 598)
#define FLAG_HIDDEN_ITEM_ROUTE14_ZINC                                      (FRLG_FLAGS_START + 599)
#define FLAG_HIDDEN_ITEM_ROUTE9_CHESTO_BERRY                               (FRLG_FLAGS_START + 600)
#define FLAG_HIDDEN_ITEM_ROUTE10_NANAB_BERRY                               (FRLG_FLAGS_START + 601)
#define FLAG_HIDDEN_ITEM_ROUTE7_WEPEAR_BERRY                               (FRLG_FLAGS_START + 602)
#define FLAG_HIDDEN_ITEM_ROUTE20_STARDUST                                  (FRLG_FLAGS_START + 603)
#define FLAG_HIDDEN_ITEM_ROUTE21_NORTH_PEARL                               (FRLG_FLAGS_START + 604)
#define FLAG_HIDDEN_ITEM_ROUTE23_MAX_ELIXIR                                (FRLG_FLAGS_START + 605)
#define FLAG_HIDDEN_ITEM_ROUTE4_RAZZ_BERRY                                 (FRLG_FLAGS_START + 606)
#define FLAG_HIDDEN_ITEM_ROUTE14_PINAP_BERRY                               (FRLG_FLAGS_START + 607)
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_FIRE_STONE                      (FRLG_FLAGS_START + 608)
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_7F_SOOTHE_BELL                      (FRLG_FLAGS_START + 609)
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_SUMMIT_SACRED_ASH                      (FRLG_FLAGS_START + 610)
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_PP_MAX                      (FRLG_FLAGS_START + 611)
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_ULTRA_BALL                      (FRLG_FLAGS_START + 612)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_DUNSPARCE_TUNNEL_NUGGET              (FRLG_FLAGS_START + 613)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_PP_UP                                (FRLG_FLAGS_START + 614)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_MAX_REPEL                (FRLG_FLAGS_START + 615)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_PEARL                    (FRLG_FLAGS_START + 616)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_STARDUST                 (FRLG_FLAGS_START + 617)
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_PEARL                                 (FRLG_FLAGS_START + 618)
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_ULTRA_BALL                            (FRLG_FLAGS_START + 619)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BIG_PEARL             (FRLG_FLAGS_START + 620)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_RAZZ_BERRY            (FRLG_FLAGS_START + 621)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_SITRUS_BERRY          (FRLG_FLAGS_START + 622)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BLUK_BERRY            (FRLG_FLAGS_START + 623)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_NEST_BALL             (FRLG_FLAGS_START + 624)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST              (FRLG_FLAGS_START + 625)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STAR_PIECE            (FRLG_FLAGS_START + 626)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST_2            (FRLG_FLAGS_START + 627)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_STAR_PIECE              (FRLG_FLAGS_START + 628)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_NET_BALL                (FRLG_FLAGS_START + 629)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_GREEN_PATH_ULTRA_BALL                  (FRLG_FLAGS_START + 630)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ASPEAR_BERRY                (FRLG_FLAGS_START + 631)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ORAN_BERRY                  (FRLG_FLAGS_START + 632)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_PINAP_BERRY                 (FRLG_FLAGS_START + 633)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_LEPPA_BERRY                            (FRLG_FLAGS_START + 634)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_BIG_PEARL              (FRLG_FLAGS_START + 635)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_PEARL                  (FRLG_FLAGS_START + 636)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_NANAB_BERRY            (FRLG_FLAGS_START + 637)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE_RAWST_BERRY  (FRLG_FLAGS_START + 638)
#define FLAG_HIDDEN_ITEM_VIRIDIAN_CITY_GYM_MACHO_BRACE                     (FRLG_FLAGS_START + 639)
#define FLAG_HIDDEN_ITEM_SSANNE_EXTERIOR_LAVA_COOKIE                       (FRLG_FLAGS_START + 640)

#define FLAG_DEFEATED_BROCK           (FRLG_FLAGS_START + 641)
#define FLAG_DEFEATED_MISTY           (FRLG_FLAGS_START + 642)
#define FLAG_DEFEATED_LT_SURGE        (FRLG_FLAGS_START + 643)
#define FLAG_DEFEATED_ERIKA           (FRLG_FLAGS_START + 644)
#define FLAG_DEFEATED_KOGA            (FRLG_FLAGS_START + 645)
#define FLAG_DEFEATED_SABRINA         (FRLG_FLAGS_START + 646)
#define FLAG_DEFEATED_BLAINE          (FRLG_FLAGS_START + 647)
#define FLAG_DEFEATED_LEADER_GIOVANNI (FRLG_FLAGS_START + 648)
#define FLAG_DEFEATED_LORELEI         (FRLG_FLAGS_START + 649)
#define FLAG_DEFEATED_BRUNO           (FRLG_FLAGS_START + 650)
#define FLAG_DEFEATED_AGATHA          (FRLG_FLAGS_START + 651)
#define FLAG_DEFEATED_LANCE           (FRLG_FLAGS_START + 652)
#define FLAG_DEFEATED_CHAMP           (FRLG_FLAGS_START + 653)

#define FLAG_0x82A                                                  0
#define FLAG_0x82B                                                  0
#define FLAG_SYS_SET_TRAINER_CARD_PROFILE                           (FRLG_FLAGS_START + 654)
#define FLAG_0x82E                                                  0
#define FLAG_SYS_ON_CYCLING_ROAD                                    (FRLG_FLAGS_START + 655)
#define FLAG_0x831                                                  0
#define FLAG_0x832                                                  0
#define FLAG_0x833                                                  0
#define FLAG_0x835                                                  0
...
#define FLAG_0x83A                                                  0
#define FLAG_SYS_SAW_HELP_SYSTEM_INTRO                              (FRLG_FLAGS_START + 656)
#define FLAG_0x83D                                                  0
#define FLAG_OPENED_START_MENU                                      (FRLG_FLAGS_START + 657)
#define FLAG_SYS_PC_STORAGE_DISABLED                                (FRLG_FLAGS_START + 658)
#define FLAG_SYS_SEVII_MAP_123                                      (FRLG_FLAGS_START + 659)
#define FLAG_SYS_SEVII_MAP_4567                                     (FRLG_FLAGS_START + 660)
#define FLAG_SYS_GOT_BERRY_POUCH                                    (FRLG_FLAGS_START + 661)
#define FLAG_SYS_UNLOCKED_TANOBY_RUINS                              (FRLG_FLAGS_START + 662)

// World Map Flags
#define FLAG_WORLD_MAP_PALLET_TOWN                                  (FRLG_FLAGS_START + 663)
#define FLAG_WORLD_MAP_VIRIDIAN_CITY                                (FRLG_FLAGS_START + 664)
#define FLAG_WORLD_MAP_PEWTER_CITY                                  (FRLG_FLAGS_START + 665)
#define FLAG_WORLD_MAP_CERULEAN_CITY                                (FRLG_FLAGS_START + 666)
#define FLAG_WORLD_MAP_LAVENDER_TOWN                                (FRLG_FLAGS_START + 667)
#define FLAG_WORLD_MAP_VERMILION_CITY                               (FRLG_FLAGS_START + 668)
#define FLAG_WORLD_MAP_CELADON_CITY                                 (FRLG_FLAGS_START + 669)
#define FLAG_WORLD_MAP_FUCHSIA_CITY                                 (FRLG_FLAGS_START + 670)
#define FLAG_WORLD_MAP_CINNABAR_ISLAND                              (FRLG_FLAGS_START + 671)
#define FLAG_WORLD_MAP_INDIGO_PLATEAU_EXTERIOR                      (FRLG_FLAGS_START + 672)
#define FLAG_WORLD_MAP_SAFFRON_CITY                                 (FRLG_FLAGS_START + 673)
#define FLAG_WORLD_MAP_ONE_ISLAND                                   (FRLG_FLAGS_START + 674)
#define FLAG_WORLD_MAP_TWO_ISLAND                                   (FRLG_FLAGS_START + 675)
#define FLAG_WORLD_MAP_THREE_ISLAND                                 (FRLG_FLAGS_START + 676)
#define FLAG_WORLD_MAP_FOUR_ISLAND                                  (FRLG_FLAGS_START + 677)
#define FLAG_WORLD_MAP_FIVE_ISLAND                                  (FRLG_FLAGS_START + 678)
#define FLAG_WORLD_MAP_SEVEN_ISLAND                                 (FRLG_FLAGS_START + 679)
#define FLAG_WORLD_MAP_SIX_ISLAND                                   (FRLG_FLAGS_START + 680)
#define FLAG_WORLD_MAP_ROUTE4_POKEMON_CENTER_1F                     (FRLG_FLAGS_START + 681)
#define FLAG_WORLD_MAP_ROUTE10_POKEMON_CENTER_1F                    (FRLG_FLAGS_START + 682)
#define FLAG_WORLD_MAP_VIRIDIAN_FOREST                              (FRLG_FLAGS_START + 683)
#define FLAG_WORLD_MAP_MT_MOON_1F                                   (FRLG_FLAGS_START + 684)
#define FLAG_WORLD_MAP_SSANNE_EXTERIOR                              (FRLG_FLAGS_START + 685)
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL          (FRLG_FLAGS_START + 686)
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL            (FRLG_FLAGS_START + 687)
#define FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F                            (FRLG_FLAGS_START + 688)
#define FLAG_WORLD_MAP_VICTORY_ROAD_1F                              (FRLG_FLAGS_START + 689)
#define FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F                           (FRLG_FLAGS_START + 690)
#define FLAG_WORLD_MAP_SILPH_CO_1F                                  (FRLG_FLAGS_START + 691)
#define FLAG_WORLD_MAP_POKEMON_MANSION_1F                           (FRLG_FLAGS_START + 692)
#define FLAG_WORLD_MAP_SAFARI_ZONE_CENTER                           (FRLG_FLAGS_START + 693)
#define FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM                 (FRLG_FLAGS_START + 694)
#define FLAG_WORLD_MAP_ROCK_TUNNEL_1F                               (FRLG_FLAGS_START + 695)
#define FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F                           (FRLG_FLAGS_START + 696)
#define FLAG_WORLD_MAP_POKEMON_TOWER_1F                             (FRLG_FLAGS_START + 697)
#define FLAG_WORLD_MAP_CERULEAN_CAVE_1F                             (FRLG_FLAGS_START + 698)
#define FLAG_WORLD_MAP_POWER_PLANT                                  (FRLG_FLAGS_START + 699)
#define FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR                          (FRLG_FLAGS_START + 700)
#define FLAG_WORLD_MAP_MT_EMBER_EXTERIOR                            (FRLG_FLAGS_START + 701)
#define FLAG_WORLD_MAP_THREE_ISLAND_BERRY_FOREST                    (FRLG_FLAGS_START + 702)
#define FLAG_WORLD_MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE            (FRLG_FLAGS_START + 703)
#define FLAG_WORLD_MAP_FIVE_ISLAND_ROCKET_WAREHOUSE                 (FRLG_FLAGS_START + 704)
#define FLAG_WORLD_MAP_TRAINER_TOWER_LOBBY                          (FRLG_FLAGS_START + 705)
#define FLAG_WORLD_MAP_SIX_ISLAND_DOTTED_HOLE_1F                    (FRLG_FLAGS_START + 706)
#define FLAG_WORLD_MAP_FIVE_ISLAND_LOST_CAVE_ENTRANCE               (FRLG_FLAGS_START + 707)
#define FLAG_WORLD_MAP_SIX_ISLAND_PATTERN_BUSH                      (FRLG_FLAGS_START + 708)
#define FLAG_WORLD_MAP_SIX_ISLAND_ALTERING_CAVE                     (FRLG_FLAGS_START + 709)
#define FLAG_WORLD_MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER     (FRLG_FLAGS_START + 710)
#define FLAG_WORLD_MAP_THREE_ISLAND_DUNSPARCE_TUNNEL                (FRLG_FLAGS_START + 711)
#define FLAG_WORLD_MAP_SEVEN_ISLAND_SEVAULT_CANYON_TANOBY_KEY       (FRLG_FLAGS_START + 712)
#define FLAG_WORLD_MAP_BIRTH_ISLAND_EXTERIOR                        (FRLG_FLAGS_START + 713)
