...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    // emerald+: Kanto. The leaders repeat one id across all five slots, which is
    // the pattern Hoenn's own Elite Four already use for trainers with no
    // escalating variants - a rematch is the same fight, never a weaker one.
    [REMATCH_KANTO_BROCK] = REMATCH(TRAINER_LEADER_BROCK, TRAINER_LEADER_BROCK, TRAINER_LEADER_BROCK, TRAINER_LEADER_BROCK, TRAINER_LEADER_BROCK, MAP_PEWTER_CITY),
    [REMATCH_KANTO_MISTY] = REMATCH(TRAINER_LEADER_MISTY, TRAINER_LEADER_MISTY, TRAINER_LEADER_MISTY, TRAINER_LEADER_MISTY, TRAINER_LEADER_MISTY, MAP_CERULEAN_CITY),
    [REMATCH_KANTO_LT_SURGE] = REMATCH(TRAINER_LEADER_LT_SURGE, TRAINER_LEADER_LT_SURGE, TRAINER_LEADER_LT_SURGE, TRAINER_LEADER_LT_SURGE, TRAINER_LEADER_LT_SURGE, MAP_VERMILION_CITY),
    [REMATCH_KANTO_ERIKA] = REMATCH(TRAINER_LEADER_ERIKA, TRAINER_LEADER_ERIKA, TRAINER_LEADER_ERIKA, TRAINER_LEADER_ERIKA, TRAINER_LEADER_ERIKA, MAP_CELADON_CITY),
    [REMATCH_KANTO_KOGA] = REMATCH(TRAINER_LEADER_KOGA, TRAINER_LEADER_KOGA, TRAINER_LEADER_KOGA, TRAINER_LEADER_KOGA, TRAINER_LEADER_KOGA, MAP_FUCHSIA_CITY),
    [REMATCH_KANTO_SABRINA] = REMATCH(TRAINER_LEADER_SABRINA, TRAINER_LEADER_SABRINA, TRAINER_LEADER_SABRINA, TRAINER_LEADER_SABRINA, TRAINER_LEADER_SABRINA, MAP_SAFFRON_CITY),
    [REMATCH_KANTO_BLAINE] = REMATCH(TRAINER_LEADER_BLAINE, TRAINER_LEADER_BLAINE, TRAINER_LEADER_BLAINE, TRAINER_LEADER_BLAINE, TRAINER_LEADER_BLAINE, MAP_CINNABAR_ISLAND),
    [REMATCH_KANTO_GIOVANNI] = REMATCH(TRAINER_LEADER_GIOVANNI, TRAINER_LEADER_GIOVANNI, TRAINER_LEADER_GIOVANNI, TRAINER_LEADER_GIOVANNI, TRAINER_LEADER_GIOVANNI, MAP_VIRIDIAN_CITY),
    // The Elite Four do have a second party each, so their entry escalates once
    // and then holds - the same shape their rooms already use.
    [REMATCH_KANTO_LORELEI] = REMATCH(TRAINER_ELITE_FOUR_LORELEI, TRAINER_ELITE_FOUR_LORELEI_2, TRAINER_ELITE_FOUR_LORELEI_2, TRAINER_ELITE_FOUR_LORELEI_2, TRAINER_ELITE_FOUR_LORELEI_2, MAP_POKEMON_LEAGUE_LORELEIS_ROOM),
    [REMATCH_KANTO_BRUNO] = REMATCH(TRAINER_ELITE_FOUR_BRUNO, TRAINER_ELITE_FOUR_BRUNO_2, TRAINER_ELITE_FOUR_BRUNO_2, TRAINER_ELITE_FOUR_BRUNO_2, TRAINER_ELITE_FOUR_BRUNO_2, MAP_POKEMON_LEAGUE_BRUNOS_ROOM),
    [REMATCH_KANTO_AGATHA] = REMATCH(TRAINER_ELITE_FOUR_AGATHA, TRAINER_ELITE_FOUR_AGATHA_2, TRAINER_ELITE_FOUR_AGATHA_2, TRAINER_ELITE_FOUR_AGATHA_2, TRAINER_ELITE_FOUR_AGATHA_2, MAP_POKEMON_LEAGUE_AGATHAS_ROOM),
    [REMATCH_KANTO_LANCE] = REMATCH(TRAINER_ELITE_FOUR_LANCE, TRAINER_ELITE_FOUR_LANCE_2, TRAINER_ELITE_FOUR_LANCE_2, TRAINER_ELITE_FOUR_LANCE_2, TRAINER_ELITE_FOUR_LANCE_2, MAP_POKEMON_LEAGUE_LANCES_ROOM),
};
